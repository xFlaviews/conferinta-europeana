...
<div class="mt-6">
	<div class="card">
		...
		<div class="flex flex-wrap justify-between items-center gap-2 p-6">
			<a href="{{ route('backend.newsletter.create') }}" class="btn bg-danger/20 text-sm font-medium text-danger hover:text-white hover:bg-danger">
			...
			<table class="w-full divide-y divide-gray-300 dark:divide-gray-700">
				<thead class="bg-slate-300 bg-opacity-20 border-t dark:bg-slate-800 divide-gray-300 dark:border-gray-700">
					<tr>
						...
						<th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-gray-200">{{ __('Subject') }}</th>
