                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header text-regular-20" id="headingTwoAddedAfter">
                                    <button class="accordion-button collapsed text-regular-20 fw-semibold"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwoAddedAfter"
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header text-regular-20" id="headingTwoNhalf">
                                    <button class="accordion-button collapsed text-regular-20 fw-semibold"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwoNHalf"
                                        aria-expanded="false" aria-controls="collapseTwoNHalf">
                            ...
                            <div class="accordion-item d-none">
                                <h2 class="accordion-header text-regular-20" id="headingTwoo">
                                    <button class="accordion-button collapsed text-regular-20 fw-semibold"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwoo"
