<section class="align-items-center d-flex flex-column justify-content-center text-center mb-5" id="info-section">
    <div class="align-items-center d-flex flex-column justify-content-center text-center col-8">
        <h1 class="display-4 fw-bold mb-4">Informatii despre anul acesta</h1>
        ...
        <hr class="mt-3 mb-3 mt-lg-5 mb-lg-5 w-100" />

    </div>
    <div class="col-10 mt-5 info-sub-sections d-flex flex-column justify-content-center">
        ...
        <div class="d-flex row px-0 px-md-5  justify-content-center justify-content-lg-between">
          <img src="{{ Vite::asset('resources/images/radial-circle.svg') }}" alt="Logo"
            ...
            <div class="col-12 col-lg-6 text-start">
                <div class="mb-3 accent-text">INVITATI</div>
                <div>
                    <h1 class="fw-bold mb-4">Invitati Speciali</h1>
                </div>
                <div><span class="paragraph-regular-20">Anul acesta, la conferinta Europeana de Tineret si Famili editia
                        2024, vom avea ca invitat special pe Fratele Luigi Mitoi, pe care l-am cunoscut deja in prima
                        edizie, anul 2019.</span></div>
            </div>
        ...
        <div class="container row justify-content-center mx-auto ">
            ...
            <div class="col-12">
                <hr class="mb-5 mt-5 mb-lg-5 w-100" />
            </div>
        </div>
        ...
        <div class="d-flex row px-0 px-md-5 mt-3  justify-content-center justify-content-lg-between">
            ...
            <div class="col-12 col-lg-6 text-start order-2 order-lg-1 text-start text-lg-end mb-5">
                ...
                <div><span class="paragraph-regular-20">Tematica anului acesta va fi IMPLICAREA. Vom avea discuții și
                        presentări dedicate acestui subiect, oferind oportunități valoroase pentru toți participanți să
                        invețe și să se implice activ.</span></div>
            </div>
        ...
        <div class="d-flex row px-0 px-md-5 mt-3  justify-content-center justify-content-lg-between">
            ...
            <div class="col-12 col-lg-6 text-start">
                ...
                <div><span class="paragraph-regular-20">La fel ca și anii trecuți, Conferința Europeană se va ține la
                        "BELLA ITALIA EFA VILLAGE" în Lignano Sabbiadoro (UD), Italia</span></div>
            </div>
        ...
        <div class="d-flex row px-0 px-md-5 mt-3  justify-content-center justify-content-lg-between">
         <img src="{{ Vite::asset('resources/images/radial-circle.svg') }}" alt="Logo"
            ...
            <div class="col-10 col-lg-5 mb-5 order-1 order-sm-2">
                <div class="position-relative container-wrapper">
                    ...
                    <div
                        ...
                        <h1 class="display-1 fw-semibold counter-text">111</h1>
                        <h1 class="mb-2 mb-lg-4 counter-label">ZILE</h1>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-6 text-start order-2 order-sm-1 text-start text-lg-end mb-5">
                ...
                <div><span class="paragraph-regular-20">Conferința Europeană se va ține în datele de 1-2-3 NOIEMBRIE. Vă
                        așteptăm cu drag pentru a petrece momente memorabile impreună!</span></div>
            </div>
        ...
        <div class="d-flex row px-0 px-md-0 mt-3  justify-content-center justify-content-lg-between">
            <div
            ...
            <div class="col-12 col-lg-4 text-start order-1 mb-5">
                <div class="mb-3 accent-text">DIN TRECUT</div>
                <div>
                    <h1 class="fw-bold display-6 mb-4">Află Despre Conferițele Trecute</h1>
                </div>
                <div><span class="paragraph-regular-20">Ești interesat să vezi cum s-au desfășurat edițiile trecute?
                        Accesează imaginile pentru a viziona <span class="text-decoration-underline">videourile
                            live</span> din ani anteriori.</span></div>
            </div>
        </div>
    </div>
</section>
